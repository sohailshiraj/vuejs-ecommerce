      ...
      <v-row>
        ...
        <v-col :cols="12" md="3" sm="12" style="background-color: lightgray">
            ...
            <template v-slot:default>
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right" style="width: 50px">${{ cart.length > 0 ? 10.0 : 0.0 }}</td>
                </tr>
                <tr>
                  <td>Tax</td>
          ...
          <div class="text-center">
            <v-btn class="white--text mt-5" outlined @click="proceedToBuy()">Proceed to Buy</v-btn>
          </div>
        </v-col>
      </v-row>
    </v-container>
  ...
  methods: {
    ...
    getSubTotal() {
      ...
      this.cart.forEach(element => {
        let product = this.getProduct(element.productId)
        let price = this.getDiscountedValue(product.price, product.discount)
