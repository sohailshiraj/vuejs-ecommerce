      ...
      <div>
        <v-row  v-if="purchases.length > 0">
          <v-col
            ...
            lg="8"
            cols="12"
            :key="purchase.id" v-for="purchase in purchases"
          >
              ...
              <v-row class="ma-0 h-full">
                ...
                >
                  ...
                  <v-card-text :key="purchase.id+item.id" v-for="(item, index) in purchase.items">
                    {{index + 1}}. Product: <b>{{item.product.name}}</b>, Quantity: <b>{{item.quantity}}</b>
                  </v-card-text>
                </v-col>
                <v-col
                  cols="12"
                ...
                >
                  <div class="membership-pricing">
                    <p class="mt-16 text--primary">
                      ...
                      <sup style="font-size: 3.75rem;
    top: 9px;" class="font-weight-semibold">{{purchase.total}}</sup>
      ...
      <p class="font-weight-light pa-1" v-if="purchases.length == 0">
